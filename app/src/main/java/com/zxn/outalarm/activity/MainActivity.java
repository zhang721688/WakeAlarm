...
import com.zxn.outalarm.Utils.ActivityManager;
import com.zxn.outalarm.Utils.DividerItemDecoration;
import com.zxn.outalarm.Utils.MyTimeSorter;
        ...
        class MyViewHolder extends RecyclerView.ViewHolder implements
            ...
            public void setActiveImage(String active) {
                if (active.equals("true")) {
                    mActiveImage.setImageResource(R.drawable.ic_ring_on);
                } else if (active.equals("false")) {
                    mActiveImage.setImageResource(R.drawable.ic_ring_off);
                }
            }
